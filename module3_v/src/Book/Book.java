...
public class Book {
  ...
  /**
   * Construct a Book object that has the provided title, author, book type and price
   *
  ...
  /**
   * Getter method to get the book type.
   */
  ...
  public String toString() {
    ...
    str = "Title: " + this.title + "\n" +
            "Author: " + this.author + "\n" +
            "Type: ";
    // switch statement that is used for enum but it could use for other data type too
    switch (bookType) {
      case PAPERBACK:
        str = str + "Paperback";
        break;
  ...
  /**
   * Compute the sale price of this Book given using the given discount rate (as
   * a percentage) and return a version of this book with the discounted price
   *
  ...
  */
    ...
    return new Book(this.title, this.author, this.bookType, discountedPrice);
  }
}